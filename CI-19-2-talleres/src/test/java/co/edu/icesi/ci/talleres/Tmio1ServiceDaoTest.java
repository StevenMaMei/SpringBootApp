...
public class Tmio1ServiceDaoTest {
	...
	public void deleteTest() {
		...
		tmio1ServicioDao.delete(s1);
		
		try {
			assertTrue(tmio1ServicioDao.findById(pk1)==null);
	...
	public void findByIdTest() {
		...
		Tmio1Servicio ser= tmio1ServicioDao.findById(pk1);
		assertTrue(ser!= null);
		tmio1ServicioDao.delete(s1);
		ser= tmio1ServicioDao.findById(pk1);
		assertTrue(ser== null);
	...
	public void findAllTest() {
		...
		List<Tmio1Servicio> con= tmio1ServicioDao.findAll();
